...
public class Messages {
    ...
    public String tradeCustomerJoined = "<green>%player% joined your trade <click:run_command:'/trade %player%'><dark_aqua>[Click to open or execute /trade %player%]</dark_aqua></click>";
    ...
    public String tradeRunning = "<color:#39abab>The trade is still active in background</color><br><color:#bfbfbf><click:run_command:'/trade %player%'>[Click to resume]</click> or <click:suggest_command:'/trade'>[/trade]</click>";
