...
public class Messages {
    ...
    public String alreadyInTrade = "<red>You already trading with %player% <click:run_command:'/trade %player%'><dark_aqua>[Click to resume or execute /trade %player%]</dark_aqua></click>";
